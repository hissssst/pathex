  ...
  configs: [
    %{
      ...
      checks: [
        ...
        {Credo.Check.Design.TagTODO, false}, # We allow TODOs in comments
        ...
        {Credo.Check.Refactor.LongQuoteBlocks, [max_line_count: 155]},
        {Credo.Check.Refactor.MapInto, false}, # Not suitable for 1.9.1
